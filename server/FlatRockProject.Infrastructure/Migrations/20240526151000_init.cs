        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuestionableAuthorId = table.Column<int>(type: "int", nullable: false),
                    CorrectAuthorId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BinaryQuestions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BinaryQuestions_Authors_CorrectAuthorId",
                        column: x => x.CorrectAuthorId,
                        principalTable: "Authors",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BinaryQuestions_Authors_QuestionableAuthorId",
                        column: x => x.QuestionableAuthorId,
                        principalTable: "Authors",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BinaryQuestions_Quote_QuoteId",
                        column: x => x.QuoteId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MultipleChoiceQuestions_Quote_QuoteId",
                        column: x => x.QuoteId,
                        principalTable: "Quote",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorChoiceId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BinaryQuestions_CorrectAuthorId",
                table: "BinaryQuestions",
                column: "CorrectAuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_BinaryQuestions_QuestionableAuthorId",
                table: "BinaryQuestions",
                column: "QuestionableAuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_BinaryQuestions_QuoteId_CorrectAuthorId_QuestionableAuthorId",
                table: "BinaryQuestions",
